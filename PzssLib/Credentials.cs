...
namespace PzssLib
{
    ...
    public class Credentials
    {
        ...
        public bool LoadCredentials(string fileName)
        {
            try
            {
                var directory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "PzssLib");
                ...
                var entropyPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "PzssLib");
